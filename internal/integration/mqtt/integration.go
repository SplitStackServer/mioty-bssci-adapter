...
import (
	...
	"github.com/SplitStackServer/mioty-bssci-adapter/internal/integration/auth"
...
type Integration struct {
	...
	serverCommandHandler  func(*bs.ServerCommand)
	serverResponseHandler func(*bs.ServerResponse)
