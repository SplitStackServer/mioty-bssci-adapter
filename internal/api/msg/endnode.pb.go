...
const file_msg_endnode_proto_rawDesc = "" +
	"\n" +
	"\x11msg/endnode.proto\x12\x03msg\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/duration.proto\"\x9a\x03\n" +
	"\x13ProtoEndnodeMessage\x12\x15\n" +
	"\x06bs_eui\x18\x01 \x01(\tR\x05bsEui\x12\x1f\n" +
	"\vendnode_eui\x18\x02 \x01(\tR\n" +
	"endnodeEui\x12*\n" +
	"\x03att\x18\x04 \x01(\v2\x16.msg.EndnodeAttMessageH\x00R\x03att\x12*\n" +
	"\x03det\x18\x05 \x01(\v2\x16.msg.EndnodeDetMessageH\x00R\x03det\x124\n" +
	"\aul_data\x18\x06 \x01(\v2\x19.msg.EndnodeUlDataMessageH\x00R\x06ulData\x12<\n" +
	"\n" +
	"dl_rx_stat\x18\a \x01(\v2\x1c.msg.EndnodeDownlinkRxStatusH\x00R\bdlRxStat\x123\n" +
	"\x06dl_res\x18\b \x01(\v2\x1a.msg.EndnodeDownlinkResultH\x00R\x05dlRes\x12D\n" +
	"\n" +
	"vm_ul_data\x18\t \x01(\v2$.msg.EndnodeVariableMacUlDataMessageH\x00R\bvmUlDataB\x04\n" +
	"\x02v1\"\xde\x02\n" +
	...
	"\x04meta\x18\x06 \x01(\v2\x1a.msg.EndnodeUplinkMetadataR\x04meta\x12!\n" +
	...
	"\x04meta\x18\x03 \x01(\v2\x1a.msg.EndnodeUplinkMetadataR\x04meta\"\xc4\x01\n" +
	...
	"\x04meta\x18\x04 \x01(\v2\x1a.msg.EndnodeUplinkMetadataR\x04meta\x12\x17\n" +
	...
	"\tdl_rx_snr\x18\x04 \x01(\x01R\adlRxSnr\"\xf8\x02\n" +
	...
	"\x06eq_snr\x18\a \x01(\x01H\x02R\x05eqSnr\x88\x01\x01\x12B\n" +
	"\x0esubpacket_info\x18\b \x03(\v2\x1b.msg.EndnodeUplinkSubpacketR\rsubpacketInfoB\x0e\n" +
	"\f_rx_durationB\n" +
	"\n" +
	"\b_profileB\t\n" +
	"\a_eq_snr\"\x81\x01\n" +
	...
	"\x06result\x18\x04 \x01(\x0e2\x17.msg.DownlinkResultEnumR\x06result\x123\n" +
	"\atx_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x06txTime\x12\"\n" +
	"\rep_packet_cnt\x18\x06 \x01(\rR\vepPacketCnt\"\xb5\x02\n" +
	...
	"\tLOW_DELAY\x10\x02B&Z$mioty-bssci-adapter/internal/api/msgb\x06proto3"
